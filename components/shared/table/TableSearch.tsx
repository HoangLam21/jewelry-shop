  ...
  return (
    <div className="w-full flex gap-4 mb-6">
      ...
      <div className="flex-1 relative">
        <div
          className={`h-12 flex items-center gap-3 px-4 rounded-xl border-2 transition-all duration-300 bg-white dark:bg-dark-300 ${
            isFocused
              ? "border-primary-100 shadow-lg shadow-primary-100/20"
        ...
        >
          ...
          <input
            ...
            className="flex-1 bg-transparent outline-none text-dark100_light500 placeholder:text-gray-400 dark:placeholder:text-gray-500 text-sm"
          />
          {searchQuery && (
            <button
              onClick={() => {
