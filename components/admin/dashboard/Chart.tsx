        ...
        <CardHeader className="space-y-0 border-b p-0">
          <div className="animate-pulse">
            ...
            <div className="flex h-20">
              <div className="flex-1 border-r bg-gray-100 dark:bg-gray-800"></div>
              <div className="flex-1 bg-gray-100 dark:bg-gray-800"></div>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-6">
          <div className="h-[250px] bg-gray-100 dark:bg-gray-800 animate-pulse rounded"></div>
        </CardContent>
      </Card>
    );
  }
      ...
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          ...
          <CardDescription className="text-gray-600 dark:text-gray-400">
            Financial performance for the last 3 months
          </CardDescription>
        </div>
        <div className="flex">
          {["income", "outcome"].map((key) => {
            ...
            return (
              <button
                key={chart}
                data-active={activeChart === chart}
                className="relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-l data-[active=true]:bg-primary-100/5 sm:border-l sm:border-t-0 sm:px-8 sm:py-6 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                onClick={() => setActiveChart(chart)}
              >
